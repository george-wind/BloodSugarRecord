...
public class MedicareRecordDbHelper extends SQLiteOpenHelper {
    ...
    public static final String tableName_BLODD_PRESSURE1 = "blood_pressure1";
    ...
    public static final String COLUMN_LOW_RESULT = "low_result";
    public static final String COLUMN_HIGH_RESULT = "high_result";
    ...
    private static final int BLOOD_SUGAR_DB_VERISON = 3;//first version，2018/4/12; third version；2018/4/29
...
//                    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        tableContent.put(COLUMN_LOW_RESULT, " text");
        tableContent.put(COLUMN_HIGH_RESULT, " text");
        tableContent.put(COLUMN_TEST_TIME_MILLIS, " integer");
        tableContent.put(COLUMN_STATE, " integer");
        tableContent.put(COLUMN_TEST_YEAR, " integer");
        tableContent.put(COLUMN_TEST_MONTH, " integer");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        if (oldVersion == 2) {
            db.delete(this.tableName_BLODD_PRESSURE,null,null);
            String sql5 = "DROP TABLE "+this.tableName_BLODD_PRESSURE;
            db.execSQL(sql5);
            String sql2 = "CREATE TABLE IF NOT EXISTS ";
            sql2 += this.tableName_BLODD_PRESSURE;
            sql2 += "(";
    ...
    public List<BloodSugarEntity> loadNormalBloodSugarCheckDatas(String tableName, int start, int count, String year, String month) {
    ...
    public List<BloodPressureEntity> loadNormalBloodPressureCheckDatas(String tableName, int start, int count, String year, String month) {
        List<BloodPressureEntity> bloodSugarEntityList = new ArrayList<>();
        SQLiteDatabase database = getReadableDatabase();
        String[] columns = new String[]{COLUMN_ID, COLUMN_LOW_RESULT,COLUMN_HIGH_RESULT, COLUMN_TEST_TIME_MILLIS};
        String limit = null;
        String selection = COLUMN_STATE + " =? ";
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                entity.setId(cursor.getLong(0));
                entity.setLowResult(cursor.getString(1));
                entity.setHighResult(cursor.getString(2));
                entity.setTestTimeStamp(cursor.getLong(3));
                bloodSugarEntityList.add(entity);
            }
        } catch (Exception ex) {
    ...
    public List<BloodSugarEntity> loadAllBloodSugarCheckRecords(String tableName) {
        List<BloodSugarEntity> bloodSugarEntityList = new ArrayList<>();
        SQLiteDatabase database = getReadableDatabase();
    ...
    public List<BloodPressureEntity> loadAllBloodPressureCheckRecords(String tableName) {
        List<BloodPressureEntity> bloodSugarEntityList = new ArrayList<>();
        SQLiteDatabase database = getReadableDatabase();
        String[] columns = new String[]{COLUMN_ID, COLUMN_LOW_RESULT,COLUMN_HIGH_RESULT, COLUMN_TEST_TIME_MILLIS, COLUMN_STATE};
        String limit = null;
        String selection = null;
        String[] stringArgs = null;
        Cursor cursor = null;
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                entity.setHighResult(cursor.getString(2));
                entity.setTestTimeStamp(cursor.getLong(3));
                entity.setState(cursor.getInt(4));
                bloodSugarEntityList.add(entity);
            }
        } catch (Exception ex) {
    ...
    public int deleteBloodSugarCheckDataByLogic(String tableName, BloodSugarEntity entity) {
        entity.setState(1);
    ...
    public int deleteBloodPressureCheckDataByLogic(String tableName, BloodPressureEntity entity) {
        entity.setState(1);
        SQLiteDatabase database = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_STATE, entity.getState());
    ...
    public long insertBloodSugarCheckData(String tableName, BloodSugarEntity entity) {
        ContentValues contentValues = new ContentValues();
    ...
    public long insertBloodPressureCheckData(String tableName, BloodPressureEntity entity) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_LOW_RESULT, entity.getLowResult());
        contentValues.put(COLUMN_HIGH_RESULT, entity.getHighResult());
        contentValues.put(COLUMN_TEST_TIME_MILLIS, entity.getTestTimeStamp());
        contentValues.put(COLUMN_TEST_DAY, entity.getTestDay());
        contentValues.put(COLUMN_TEST_YEAR, entity.getTestYear());
        contentValues.put(COLUMN_TEST_MONTH, entity.getTestMonth());
