...
public  class CheckBloodSugarActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void setRefreshLayout() {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                mCheckDataList = MedicareRecordDbHelper.getInstance(mActivity).loadNormalBloodSugarCheckDatas(mTableName,0,count,null,null);
...
//        });
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tv_all_record:
                Intent allRecordIntent = new Intent(mActivity,AllBloodSugarRecordsActivity.class);
    ...
    private void responseToConfirm() {
        ...
        MedicareRecordDbHelper.getInstance(mActivity).insertBloodSugarCheckData(mTableName,entity);
        mSmartRefreshLayout.autoRefresh();
