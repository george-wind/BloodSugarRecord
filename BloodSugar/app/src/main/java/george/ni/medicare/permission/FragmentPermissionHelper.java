...
public class FragmentPermissionHelper implements OnActivityPermissionCallback {
    ...
    private FragmentPermissionHelper(@NonNull Activity context, @NonNull Fragment fragment) {
    ...
    private FragmentPermissionHelper(@NonNull Activity context, @NonNull Fragment fragment, @NonNull OnPermissionCallback permissionCallback) {
        this.context = context;
        this.fragment = fragment;
        this.permissionCallback = permissionCallback;
    }

    public static FragmentPermissionHelper getInstance(@NonNull Activity context, @NonNull Fragment fragment) {
        return new FragmentPermissionHelper(context,fragment);
    }

    public static FragmentPermissionHelper getInstance(@NonNull Activity context, @NonNull Fragment fragment, @NonNull OnPermissionCallback permissionCallback) {
        return new FragmentPermissionHelper(context,fragment, permissionCallback);
    }
     ...
     */
    public FragmentPermissionHelper setForceAccepting(boolean forceAccepting) {
     ...
     */
    public FragmentPermissionHelper request(@NonNull Object permissionName) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!permissionName.equalsIgnoreCase(Manifest.permission.SYSTEM_ALERT_WINDOW)) {
                if (isPermissionDeclined(permissionName)) {
                    if (isExplanationNeeded(permissionName)) {
                        ...
                        fragment.requestPermissions(new String[]{permissionName}, REQUEST_PERMISSIONS);
                    }
                } else {
     ...
     * <p/>
     * consider using {@link FragmentPermissionHelper#openSettingsScreen(Context)} to open settings screen
     */
