...
public class AllBloodSugarRecordsActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void setRefreshLayout() {
        ...
        mSmartRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                ...
                mBloodSugarDataList = MedicareRecordDbHelper.getInstance(mActivity).loadNormalBloodSugarCheckDatas(mTableName, -1, -1, year, month);
...
//        });
                    ...
                    permissionHelper = PermissionHelper.getInstance(mActivity, new OnPermissionCallback() {
                        ...
                        public void onPermissionNeedExplanation(@NonNull final String permissionName) {
                            AlertDialog alertDialog = PermissionAlterDialogFactory.getAlertDialog(
                                    AllBloodSugarRecordsActivity.this,
                                    "请求权限",
                                    "允许",
                                    "请开启读写文件权限",
    ...
    class ExportRecordsTask extends AsyncTask<Void, Void, Void> {
        ...
        String getExportPath() {
            ...
            path = directory.getAbsolutePath()+File.separator+"BloodSugarRecord.txt";
            return path;
        }
    }
}
